...
const jobStore = await import("../plugins/grok/scripts/lib/job-store.mjs");
const { jobsDir } = await import("../plugins/grok/scripts/lib/paths.mjs");
const { resolveRepoRoot, repoId } = await import("../plugins/grok/scripts/lib/repo-identity.mjs");
